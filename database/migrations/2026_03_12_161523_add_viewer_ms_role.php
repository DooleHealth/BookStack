...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Create the Viewer-MS role
        $viewerMsId = DB::table('roles')->insertGetId([
            'display_name'   => 'Viewer-MS',
            'description'    => 'User can view admin-books & normal-books & their content behind authentication',
            'system_name'    => 'viewer_ms',
            'external_auth_id' => '',
            'mfa_enforced'   => false,
        ...
        // Copy all permissions from Viewer to Viewer-MS
    ...
    {
        $role = DB::table('roles')->where('display_name', 'Viewer-MS')->first();
