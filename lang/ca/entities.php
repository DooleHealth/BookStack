...
return [
    ...
    'pdf_exports_title' => 'Exportacions PDF',
    'pdf_exports_desc' => 'Aquí pots veure l\'estat i descarregar les teves exportacions PDF.',
    'pdf_exports_empty' => 'No s\'ha generat cap exportació PDF encara.',
    'pdf_export_status_pending' => 'Pendent',
    'pdf_export_status_processing' => 'Processant',
    'pdf_export_status_completed' => 'Llest',
    'pdf_export_status_expired' => 'Caducat',
    'pdf_export_status_failed' => 'Fallat',
    'pdf_export_col_type' => 'Tipus',
    'pdf_export_col_date' => 'Data',
    ...
    'book_versions_desc' => 'Les versions etiquetades representen instantànies immutables d\'aquest llibre en un moment específic.', 
    'book_versions_none' => 'Encara no s\'han etiquetat versions per a aquest llibre.', 
    'book_version_create' => 'Etiquetar nova versió', 
    'book_version_create_desc' => 'Això crearà una instantània immutable del llibre ":name" incloent tots els seus capítols i pàgines tal com estan ara.', 
    'book_version_label_field' => 'Etiqueta de versió', 
    'book_version_label_placeholder' => 'ex. 3.2.17', 
    'book_version_summary' => 'Resum de la instantània', 
    'book_version_book_label' => 'Llibre', 
    'book_version_chapters_count' => 'Capítols', 
    'book_version_pages_count' => 'Pàgines', 
    'book_version_create_button' => 'Etiquetar versió', 
    'book_version_unique' => 'Ja existeix una versió amb aquesta etiqueta per a aquest llibre.', 
    'book_version_created' => 'Versió ":label" correctament etiquetada.', 
    'book_version_deleted' => 'Versió ":label" eliminada correctament.', 
    'book_version_delete_confirm' => 'Esteu segur que voleu suprimir aquesta versió? Aquesta acció no es pot desfer.', 
    'book_version_not_found' => 'Versió no trobada.', 
    'book_version_chapter_not_found' => 'Capítol no trobat en aquesta versió.', 
    'book_version_page_not_found' => 'Pàgina no trobada en aquesta versió.', 
    'book_version_readonly_banner' => 'Instantània de només lectura — Versió <strong>:label</strong> etiquetada amb el :date.', 
    'book_version_back_to_current' => 'Tornar al llibre actual', 
    'book_version_back_to_book' => 'Tornar a l\'índex de versió', 
    'book_version_label' => 'Versió :label', 
    'book_version_label_header' => 'Versió', 
    'book_version_book_name' => 'Nom del llibre', 
    'book_version_created_by' => 'Etiquetatge per', 
    'book_version_date' => 'Data',
];
