...
return [
    ...
    'export_pdf_file' => 'Exportar fichero PDF',
    'export_text' => 'Archivo de texto',
    'export_md' => 'Archivo Markdown',
    'export_zip' => 'ZIP portable',
    'export_pdf_generating' => 'La exportación PDF de ":name" se está generando. La recibirás por correo electrónico en breve.',
    'export_pdf_failed' => 'No se pudo iniciar la exportación PDF: :message',
    'export_pdf_email_subject' => 'Exportación PDF lista: :name',
    'export_pdf_email_greeting' => '¡Tu exportación PDF está lista!',
    'export_pdf_email_text' => 'La exportación PDF de ":name" se ha generado correctamente. Haz clic en el botón de abajo para descargarla.',
    'export_pdf_email_action' => 'Descargar PDF',
    'export_pdf_email_expiry' => 'Este enlace caducará en 7 días.',
    'pdf_exports_title' => 'Exportaciones PDF',
    'pdf_exports_desc' => 'Aquí puedes ver el estado y descargar tus exportaciones PDF.',
    'pdf_exports_empty' => 'No se ha generado ninguna exportación PDF todavía.',
    'pdf_export_status_pending' => 'Pendiente',
    'pdf_export_status_processing' => 'Procesando',
    'pdf_export_status_completed' => 'Listo',
    'pdf_export_status_expired' => 'Caducado',
    'pdf_export_status_failed' => 'Fallido',
    'pdf_export_col_type' => 'Tipo',
    'pdf_export_col_date' => 'Fecha',
    ...
    // Book Versions
    'book_versions' => 'Versiones',
    'book_versions_desc' => 'Las versiones etiquetadas representan instantáneas inmutables de este libro en un momento específico.',
    'book_versions_none' => 'Aún no se han etiquetado versiones para este libro.',
    'book_version_create' => 'Etiquetar nueva versión',
    'book_version_create_desc' => 'Esto creará una instantánea inmutable del libro ":name" incluyendo todos sus capítulos y páginas tal como están ahora.',
    'book_version_label_field' => 'Etiqueta de versión',
    'book_version_label_placeholder' => 'ej. 3.2.17',
    'book_version_summary' => 'Resumen de la instantánea',
    'book_version_book_label' => 'Libro',
    'book_version_chapters_count' => 'Capítulos',
    'book_version_pages_count' => 'Páginas',
    'book_version_create_button' => 'Etiquetar versión',
    'book_version_unique' => 'Ya existe una versión con esta etiqueta para este libro.',
    'book_version_created' => 'Versión ":label" etiquetada correctamente.',
    'book_version_deleted' => 'Versión ":label" eliminada correctamente.',
    'book_version_delete_confirm' => '¿Está seguro de que desea eliminar esta versión? Esta acción no se puede deshacer.',
    'book_version_not_found' => 'Versión no encontrada.',
    'book_version_chapter_not_found' => 'Capítulo no encontrado en esta versión.',
    'book_version_page_not_found' => 'Página no encontrada en esta versión.',
    'book_version_readonly_banner' => 'Instantánea de solo lectura — Versión <strong>:label</strong> etiquetada el :date.',
    'book_version_back_to_current' => 'Volver al libro actual',
    'book_version_back_to_book' => 'Volver al índice de versión',
    'book_version_label' => 'Versión :label',
    'book_version_label_header' => 'Versión',
    'book_version_book_name' => 'Nombre del libro',
    'book_version_created_by' => 'Etiquetado por',
    'book_version_date' => 'Fecha',
];
