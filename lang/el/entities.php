...
return [
    ...
    'pdf_exports_title' => 'Εξαγωγές PDF',
    'pdf_exports_desc' => 'Εδώ μπορείτε να δείτε την κατάσταση και να κατεβάσετε τις εξαγωγές PDF σας.',
    'pdf_exports_empty' => 'Δεν έχουν δημιουργηθεί ακόμη εξαγωγές PDF.',
    'pdf_export_status_pending' => 'Σε αναμονή',
    'pdf_export_status_processing' => 'Επεξεργασία',
    'pdf_export_status_completed' => 'Έτοιμο',
    'pdf_export_status_expired' => 'Ληγμένο',
    'pdf_export_status_failed' => 'Αποτυχημένο',
    'pdf_export_col_type' => 'Τύπος',
    'pdf_export_col_date' => 'Ημερομηνία',
