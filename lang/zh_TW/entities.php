...
return [
    ...
    'pdf_exports_title' => 'PDF匯出',
    'pdf_exports_desc' => '在這裡您可以查看狀態並下載您的PDF匯出。',
    'pdf_exports_empty' => '還沒有產生任何PDF匯出。',
    'pdf_export_status_pending' => '等待中',
    'pdf_export_status_processing' => '處理中',
    'pdf_export_status_completed' => '就緒',
    'pdf_export_status_expired' => '已過期',
    'pdf_export_status_failed' => '失敗',
    'pdf_export_col_type' => '類型',
