...
return [
    ...
    'pdf_exports_title' => 'خروجی‌های PDF',
    'pdf_exports_desc' => 'در اینجا می‌توانید وضعیت و دانلود خروجی‌های PDF خود را مشاهده کنید.',
    'pdf_exports_empty' => 'هنوز هیچ خروجی PDF ایجاد نشده است.',
    'pdf_export_status_pending' => 'در انتظار',
    'pdf_export_status_processing' => 'در حال پردازش',
    'pdf_export_status_completed' => 'آماده',
    'pdf_export_status_expired' => 'منقضی شده',
    'pdf_export_status_failed' => 'ناموفق',
    'pdf_export_col_type' => 'نوع',
    'pdf_export_col_date' => 'تاریخ',
