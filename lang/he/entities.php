...
return [
    ...
    'export_pdf' => 'קובץ PDF',
    'export_pdf_file' => 'ייצוא קובץ PDF',
    'export_text' => 'טקסט רגיל',
    'export_md' => 'קובץ Markdown',
    'export_zip' => 'Portable ZIP',

    'pdf_exports_title' => 'ייצואי PDF',
    'pdf_exports_desc' => 'כאן תוכלו לראות את המצב ולהוריד את ייצואי ה-PDF שלכם.',
    'pdf_exports_empty' => 'לא נוצרו עדיין ייצואי PDF.',
    'pdf_export_status_pending' => 'ממתין',
    'pdf_export_status_processing' => 'מעבד',
    'pdf_export_status_completed' => 'מוכן',
    'pdf_export_status_expired' => 'פג תוקף',
    'pdf_export_status_failed' => 'נכשל',
    'pdf_export_col_type' => 'סוג',
    'pdf_export_col_date' => 'תאריך',
