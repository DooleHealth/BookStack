...
return [
    ...
    'export_pdf' => 'ملف PDF',
    'export_pdf_file' => 'تصدير ملف PDF',
    'export_text' => 'ملف نص عادي',
    'export_md' => 'ملف ماركداون -Markdown-',
    'export_zip' => 'ملف مضغوط -ZIP-',

    'pdf_exports_title' => 'تصديرات PDF',
    'pdf_exports_desc' => 'هنا يمكنك عرض حالة وتحميل تصديرات PDF الخاصة بك.',
    'pdf_exports_empty' => 'لم يتم إنشاء أي تصدير PDF بعد.',
    'pdf_export_status_pending' => 'قيد الانتظار',
    'pdf_export_status_processing' => 'جاري المعالجة',
    'pdf_export_status_completed' => 'جاهز',
    'pdf_export_status_expired' => 'منتهي الصلاحية',
    'pdf_export_status_failed' => 'فشل',
    'pdf_export_col_type' => 'النوع',
    'pdf_export_col_date' => 'التاريخ',
