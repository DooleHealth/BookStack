...
return [
    ...
    'pdf_exports_desc' => 'Тут ви можете переглянути статус та завантажити ваші PDF експорти.',
    'pdf_exports_empty' => 'PDF експорти ще не були створені.',
    'pdf_export_status_pending' => 'Очікування',
    'pdf_export_status_processing' => 'Обробка',
    'pdf_export_status_completed' => 'Готово',
    'pdf_export_status_expired' => 'Закінчився',
    'pdf_export_status_failed' => 'Помилка',
