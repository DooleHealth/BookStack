...
return [
    ...
    'export_html' => '网页文件',
    'export_pdf' => 'PDF文件',
    'export_pdf_file' => '导出PDF文件',
    'export_text' => '纯文本文件',
    'export_md' => 'Markdown 文件',
    'export_zip' => '便携版本 ZIP',

    'pdf_exports_title' => 'PDF导出',
    'pdf_exports_desc' => '在这里您可以查看状态并下载您的PDF导出。',
    'pdf_exports_empty' => '还没有生成任何PDF导出。',
    'pdf_export_status_pending' => '等待中',
    'pdf_export_status_processing' => '处理中',
    'pdf_export_status_completed' => '就绪',
    'pdf_export_status_expired' => '已过期',
    'pdf_export_status_failed' => '失败',
    'pdf_export_col_type' => '类型',
    'pdf_export_col_date' => '日期',
