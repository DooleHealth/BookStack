...
return [
    ...
    'export_pdf' => 'PDF File',
    'export_pdf_file' => 'PDF ফাইল রপ্তানি করুন',
    'export_text' => 'Plain Text File',
    'export_md' => 'Markdown File',
    'export_zip' => 'Portable ZIP',

    'pdf_exports_title' => 'পিডিএফ রপ্তানি',
    'pdf_exports_desc' => 'এখানে আপনি আপনার পিডিএফ রপ্তানির স্থিতি দেখতে এবং ডাউনলোড করতে পারেন।',
    'pdf_exports_empty' => 'এখনও কোনো পিডিএফ রপ্তানি তৈরি করা হয়নি।',
    'pdf_export_status_pending' => 'অপেক্ষমাণ',
    'pdf_export_status_processing' => 'প্রক্রিয়াকরণ হচ্ছে',
    'pdf_export_status_completed' => 'প্রস্তুত',
    'pdf_export_status_expired' => 'মেয়াদোত্তীর্ণ',
    'pdf_export_status_failed' => 'ব্যর্থ',
    'pdf_export_col_type' => 'ধরন',
    'pdf_export_col_date' => 'তারিখ',
