...
return [
    ...
    'pdf_exports_title' => 'PDF експорти',
    'pdf_exports_desc' => 'Тук можете да видите състоянието и да изтеглите вашите PDF експорти.',
    'pdf_exports_empty' => 'Все още не са генерирани PDF експорти.',
    'pdf_export_status_pending' => 'Изчакващ',
    'pdf_export_status_processing' => 'Обработва се',
    'pdf_export_status_completed' => 'Готов',
    'pdf_export_status_expired' => 'Изтекъл',
    'pdf_export_status_failed' => 'Неуспешен',
