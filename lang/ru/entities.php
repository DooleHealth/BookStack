...
return [
    ...
    'export_pdf' => 'PDF файл',
    'export_pdf_file' => 'Экспорт файла PDF',
    'export_text' => 'Текстовый файл',
    'export_md' => 'Файл Markdown',
    'export_zip' => 'Portable ZIP',

    'pdf_exports_title' => 'PDF экспорты',
    'pdf_exports_desc' => 'Здесь вы можете просмотреть статус и скачать ваши PDF экспорты.',
    'pdf_exports_empty' => 'PDF экспорты ещё не были созданы.',
    'pdf_export_status_pending' => 'Ожидание',
    'pdf_export_status_processing' => 'Обработка',
    'pdf_export_status_completed' => 'Готово',
    'pdf_export_status_expired' => 'Истёк',
    'pdf_export_status_failed' => 'Ошибка',
    'pdf_export_col_type' => 'Тип',
    'pdf_export_col_date' => 'Дата',
