...
return [
    ...
    'pdf_exports_title' => 'PDFエクスポート',
    'pdf_exports_desc' => 'ここでPDFエクスポートの状態を確認し、ダウンロードできます。',
    'pdf_exports_empty' => 'まだPDFエクスポートは生成されていません。',
    'pdf_export_status_pending' => '待機中',
    'pdf_export_status_processing' => '処理中',
    'pdf_export_status_completed' => '完了',
    'pdf_export_status_expired' => '期限切れ',
    'pdf_export_status_failed' => '失敗',
    'pdf_export_col_type' => 'タイプ',
    'pdf_export_col_date' => '日付',
